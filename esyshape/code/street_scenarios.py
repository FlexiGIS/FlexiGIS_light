...
class simulateStreetLight:
    ...
    def configuration(self):
        ...
        self.input_path = "../data/input_raw_data/"
        self.input_path2 = "../data/output_data/"
        self.output_path = "../data/simulation_data/"
        self.output_path_fig = "../data/figures/"
