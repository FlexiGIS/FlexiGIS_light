...
class simulateStreetLight:
    ...
    def config(self):
        ...
        self.output_path = "../data/03_energy_requirements/"
        self.output_path_fig = "../data/04_Visualization/"
    ...
    def simulateLoadAllRoad(self):
        ...
        self.osmLines = gpd.read_file(os.path.join(
            self.input_path2, 'osm_lines/osm_lines.shp'))
        self.osmSquares = gpd.read_file(os.path.join(
            self.input_path2, 'osm_shapes/osm_shapes.shp'))
...
# write calculated street-light load of different scenarios to csv
    ...
    def get_feedInData(self):
        ...
        wind['pv'] = pv['pv']
        self.feedin = wind
        self.df6 = pd.read_csv(os.path.join(
            self.output_path, "streetlight_load.csv"),
